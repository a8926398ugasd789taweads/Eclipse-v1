...
splashLabel.Text = "Welcome to EclipseHub V1"
...
screenGui.Name = "EclipseHubMenu"
screenGui.Parent = player:WaitForChild("PlayerGui")
screenGui.ResetOnSpawn = false
screenGui.Enabled = true
screenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

-- Main Frame (1.5x bigger)
local frame = Instance.new("Frame")
frame.Name = "MainFrame"
frame.Size = UDim2.new(0,480,0,480)
frame.Position = UDim2.new(0.5,-240,0.5,-240)
...
instructionsFrame.Size = UDim2.new(1,-20,0,240)
...
local whooshSoundTemplate = Instance.new("Sound")
whooshSoundTemplate.SoundId = "rbxassetid://9114502000" -- whoosh sound
whooshSoundTemplate.Volume = 1
...
local function addHoverEffect(button)
    ...
    button.MouseEnter:Connect(function()
        ...
        TweenService:Create(button, TweenInfo.new(0.2), {Size = originalSize + UDim2.new(0,6,0,6)}):Play()
    end)
...
local function addWhooshOnClick(button)
    local sound = whooshSoundTemplate:Clone()
    sound.Parent = button
    button.MouseButton1Click:Connect(function()
        sound:Play()
        local originalSize = button.Size
        TweenService:Create(button, TweenInfo.new(0.1), {Size = originalSize + UDim2.new(0,12,0,12)}):Play()
        task.wait(0.15)
...
eclipseButton.Size = UDim2.new(0,390,0,65)
eclipseButton.Position = UDim2.new(0.5,-195,0,375)
eclipseButton.BackgroundColor3 = Color3.fromRGB(0,170,0)
eclipseButton.TextColor3 = Color3.new(1,1,1)
eclipseButton.Font = Enum.Font.SourceSansBold
eclipseButton.TextSize = 26
eclipseButton.Text = "Eclipse"
eclipseButton.ZIndex = 2
eclipseButton.Parent = frame
addHoverEffect(eclipseButton)
addWhooshOnClick(eclipseButton)
...
helpButton.Size = UDim2.new(0,90,0,45)
helpButton.Position = UDim2.new(0.5,-45,0,520)
